    ...
    with GradCAM(model=model, target_layers=[target_layer]) as cam:
        ...
        for idx, (img_tensor, label_idx) in enumerate(dataloader):
            ...
            for alpha in ALPHAS:
                ...
                xai_path = os.path.join(ROAR_BASE_DIR, "xai", f"alpha_{alpha_pct}", true_class_name)
                rnd_path = os.path.join(ROAR_BASE_DIR, "random", f"alpha_{alpha_pct}", true_class_name)
